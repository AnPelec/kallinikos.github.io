...
Αποδεικνύεται πως με αυτή την τεχνική η πολυπλοκότητα της δομής έχει βελτιωθεί από 𝛰(𝛮) σε 𝛰(𝑙𝑜𝑔𝑁), όπου Ν ο αριθμός των αντικειμένων.
...
Η πολυπλοκότητα των union-find disjoint sets, μαζί με τα δύο αυτά τρικ έχει γίνει τελικά 𝛰(𝛼(𝑁)), όπου 𝛼(𝛮) είναι το inverse Ackermann function. Για τιμές του Ν οι οποίες εμφανίζονται στους διαγωνισμούς, 𝑁 ≤ 106,𝜄𝜎𝜒ύ𝜀𝜄 𝜋𝜔𝜍 𝛼(𝛮) ≤ 6. Έτσι πολλές φορές το θεωρούμε πρακτικά σαν 𝛰(1).
